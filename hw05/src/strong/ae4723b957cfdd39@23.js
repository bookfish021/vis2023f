...
function _simple1(d3,simple,drag,apple_list,invalidation)
{
  // 指定圖表的尺寸。
  const width = 2000
    ;
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("apple_list")).define("apple_list", _apple_list);
  main.variable(observer("drag")).define("drag", ["d3"], _drag);
  main.variable(observer("simple1")).define("simple1", ["d3","simple","drag","apple_list","invalidation"], _simple1);
  return main;
}
