...
FileAttachment("untitled.csv").csv()
)}

function _3(__query,FileAttachment,invalidation){return(
__query(FileAttachment("untitled.csv"),{from:{table:"untitled"},sort:[],slice:{to:null,from:null},filter:[],select:{columns:null}},invalidation)
)}
...
md`#結論
1. 可以從工作場域看出，在收集這份問卷時，主要的傳播範圍是在文藝圈中
2. 可以很明顯的看出來，大多數人採取"減少包裝材及文宣印製"作為減少碳排放的行動，除了美術館和藝術園區這類以展覽為主的工作場域外
3. 問卷中的調查對象大多以"使用無毒媒材、再生材料、廢物利用素材等","減少包裝材及文宣印製","工作場所、活動展場的節約能源"三者為大家最常做的環保行為`
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["untitled.csv", {url: new URL("./artist.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
